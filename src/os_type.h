#ifndef SIMPLE_HTML_OS_TYPE__
#define SIMPLE_HTML_OS_TYPE__
...
namespace simple_html {
    ...
    // Define for windows
        ...
        #ifndef SIMPLE_HTML_UTF8__
            // Define useful types for win32 && wince
        ...
        #ifdef _WIN64
            typedef unsigned __int64_uint_ptr;
        #else
            typedef unsigned int uint_ptr;
        #endif

    #else
        #define SIMPLE_HTML_UTF8__
        typedef std::string tstring;
        typedef char tchar_t;
        ...
        #define t_atoi atoi
        #define t_strtod strtod
        #define t_itoa(value,buffer,size,radix) sprintf(buffer,size,"%d",value)
        #define t_strstr strstr
        #define t_tolower tolower
        #define t_isdigit isdigit
}
